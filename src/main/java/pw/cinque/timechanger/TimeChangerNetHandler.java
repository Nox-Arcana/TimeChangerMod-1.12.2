...
public class TimeChangerNetHandler extends NetHandlerPlayClient
{
    ...
    public void handleSpawnObject(final SPacketJoinGame p_147235_1_) {
        this.parent.	handleJoinGame(p_147235_1_);
    }
    ...
    public void handleDisconnect(final net.minecraft.network.play.server.SPacketDisconnect p_147253_1_) {
        this.parent.handleDisconnect(p_147253_1_);
    }
    
    public void addToSendQueue(final Packet p_147297_1_) {
        ((TimeChangerNetHandler) this.parent).addToSendQueue(p_147297_1_);
    }
    ...
    public void handleUpdateSign(final SPacketUpdateTileEntity p_147248_1_) {
        ((TimeChangerNetHandler) this.parent).handleUpdateSign(p_147248_1_);
    }
    ...
    public void handleMapChunkBulk(final SPacketChunkData p_147269_1_) {
        ((TimeChangerNetHandler) this.parent).handleMapChunkBulk(p_147269_1_);
    }
    ...
    public void handleSetCompressionLevel(final SPacketEnableCompression packetIn) {
        ((TimeChangerNetHandler) this.parent).handleSetCompressionLevel(packetIn);
    }
    ...
    public void handleEntityNBT(final SPacketEntityMetadata packetIn) {
        ((TimeChangerNetHandler) this.parent).handleEntityNBT(packetIn);
    }
    ...
    public void handleDisplayScoreboard(final SPacketDisplayObjective p_147254_1_) {
        ((TimeChangerNetHandler) this.parent).handleDisplayScoreboard(p_147254_1_);
    }
